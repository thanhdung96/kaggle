...
featModel = DecisionTreeRegressor(max_leaf_nodes=100, random_state=0)
rfe = RFE(estimator=DecisionTreeRegressor(max_leaf_nodes=100), n_features_to_select=5)
